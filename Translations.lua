Config.Languages = {
    ...
    ['cs'] = { -- Czech 🇨🇿
        ...
        ['sharedanceemotes'] = "🕺 Sdílené tance",
	...
	['sq'] = {
		...
		['propemotes'] = "📦 Emotet e Përparave",
		['favoriteemotes'] = "🌟 Të preferuar",
		...
		['cancelemote'] = "Anulo Emoten 🚷",
		['cancelemoteinfo'] = "~r~X~w~ Anulon emoten që është duke u luajtur momentalisht",
		['walkingstyles'] = "Stilet e ecjes 🚶🏻‍♂️",
		['resetdef'] = "Rivendos në parazgjedhje",
		['normalreset'] = "Normale (Rivendos)",
		['moods'] = "Gjendjet 😒",
		['infoupdate'] = "Kredite & Sugjerime 🙏🏻",
		...
		['shareemotes'] = "👫 Emotet e Ndara",
		['shareemotesinfo'] = "Ftoj një person të afërt për të emotuar",
		['sharedanceemotes'] = "🕺 Kërcime të Ndara",
...
['ar'] = { -- Arabic
        ['emotes'] = 'حركات 🎬',
        ['danceemotes'] = "🕺 حركات الرقص",
        ['animalemotes'] = "🐩 حركات الحيوانات",
        ['propemotes'] = "📦  حركات الاوبجكتات",
        ['favoriteemotes'] = "🌟 المفضلة",
        ...
        ['cancelemote'] = " الغاء الحركة 🚷",
        ['cancelemoteinfo'] = "لالغاء لعب الحركة الحالية ~r~X~w~",
	['walkingstyles'] = "اساليب المشي 🚶🏻‍",
        ['resetdef'] = "اعادتها للوضع الطبيعي",
        ['normalreset'] = "العادي (اعادة تعيين)",
        ['moods'] = "المزاج 😒",
        ...
        ['shareemotes'] = "👫 الحركات المشتركة",
        ['shareemotesinfo'] = "دعوة شخص قريب لعمل حركات معه",
        ['sharedanceemotes'] = "🕺 الرقصات المشتركة",
